...
| Book (root file prefix) | Content | Source folder |
|---|---|---|
| `vedamantrabook` | **Mantras** — a standalone collection of suktas, nyasas and mantras commonly used in daily worship (Purusha Suktam, Sri Suktam, Rudra Prashna/Chamakam, Mantra Pushpam, Sandhyavandanam, etc.) | `mantras/` |
| `AraNyakabook` | **Aranyakam** — the Taittiriya Aranyaka (its ten Prashnas, including the Taittiriya and Mahanarayana Upanishads) plus the Kathaka portion | `aranyakas/` |
| `BrahmanamBook` | **Brahmanam** — the Taittiriya Brahmana (all eight Ashtakas), with the Aranyaka appended at the end | `ashtakas/` (+ `aranyakas/`) |
| `SamhitaBook` | **Samhita** — the Taittiriya Samhita (all seven Kandas) | `kandas/` |
